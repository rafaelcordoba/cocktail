package cocktail.lib.views 
{
	...
	import cocktail.core.ui.media.VideoControl;
	...
	public class VideoView extends InteractiveView 
	{
		...
		override protected function _instantiate_display() : * 
		{
			...
			if( attribute( 'controls' ) == 'true' )
				_use_control( );
			
			return null;
		}

		private function _use_control() : void
		{
			_control = new VideoControl( video_component );
			
			sprite.addChild( _control.sprite );
		}
	}
}
